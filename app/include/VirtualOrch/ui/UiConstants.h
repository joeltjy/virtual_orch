...
inline constexpr const char *workspaceWidgetTypeVocsepOutput = "vocsepOutput";
inline constexpr const char *workspaceWidgetTypeMode = "mode";
inline constexpr const char *workspaceWidgetTypeInstrumentLogits = "instrumentLogits";
inline constexpr const char *workspaceWidgetTypeDurationLogits = "durationLogits";
inline constexpr const char *workspaceWidgetTypeReductionTemperature = "reductionTemperature";
inline constexpr const char *workspaceWidgetTypeReductionTau = "reductionTau";
inline constexpr const char *workspaceWidgetTypeOctaveDelta = "octaveDelta";
inline constexpr const char *workspaceWidgetTypeReductionModelInput = "reductionModelInput";
inline constexpr const char *workspaceWidgetTypeLogitAdjustments = "logitAdjustments";
...
inline constexpr const char *workspaceInstrumentLogitsTitle = "Instrument Logits";
inline constexpr const char *workspaceDurationLogitsTitle = "Duration Logits";
inline constexpr const char *workspaceReductionTemperatureTitle = "Reduction Temperature";
inline constexpr const char *workspaceReductionTauTitle = "Reduction Tau";
inline constexpr const char *workspaceOctaveDeltaTitle = "Octave Delta";
inline constexpr const char *workspaceLogitAdjustmentsTitle = "Logit Adjustments";
inline constexpr const char *workspaceReductionModelInputTitle = "RT Model Input";
inline constexpr const char *workspaceModeEditButtonText = "Edit";
inline constexpr const char *workspaceModeJamButtonText = "Jam";
inline constexpr const char *workspaceModePlaybackOtButtonText = "Out: OT";
inline constexpr const char *workspaceModePlaybackRtButtonText = "Out: RT";
inline constexpr const char *workspaceModePlaybackRtTooltip =
    "Reduction monitor (ch 16). Keyboard thru is unchanged.";
...
inline constexpr int workspaceModePlaybackButtonWidth = 80;
...
inline constexpr const char *workspaceModeVocsepLabel = "Vocsep";
inline constexpr const char *workspaceModeRunningText = "Running";
inline constexpr const char *workspaceModePausedText = "Paused";
inline constexpr const char *workspaceModeLoopMsSuffix = " ms";
inline constexpr const char *workspaceModeMaxPrefix = "  max:";
inline constexpr const char *workspaceModeAlertTooltip = "Click to dismiss";
inline const juce::Colour workspaceModeAlertColour{0xffc0392b};
inline constexpr int workspaceModeContentPadding = 8;
inline constexpr int workspaceModeRowHeight = 32;
inline constexpr int workspaceModeRowGap = 8;
inline constexpr int workspaceModeAlertHeight = 44;
inline constexpr float workspaceModeUiFontHeight = 16.0f;
inline constexpr float workspaceModeProfileFontHeight = 15.0f;
...
inline constexpr const char *workspaceActiveInstrumentsRtPauseLabel = "RT Pause";
inline constexpr const char *workspaceActiveInstrumentsOtPauseLabel = "OT Pause";
...
inline constexpr const char *workspaceVocsepOutputTitle = "Vocsep Output";
...
inline constexpr const char *workspaceNoteIoVoiceColumn = "voice";
...
inline constexpr const char *workspaceAddMenuReductionModelInputItem = "RT Model Input";
inline constexpr const char *workspaceAddMenuModeItem = "Mode";
inline constexpr const char *workspaceAddMenuVocsepOutputItem = "Vocsep Output";
inline constexpr const char *workspaceAddMenuInstrumentLogitsItem = "Instrument Logits";
inline constexpr const char *workspaceAddMenuDurationLogitsItem = "Duration Logits";
inline constexpr const char *workspaceAddMenuReductionTemperatureItem = "Reduction Temperature";
inline constexpr const char *workspaceAddMenuReductionTauItem = "Reduction Tau";
inline constexpr const char *workspaceAddMenuOctaveDeltaItem = "Octave Delta";
inline constexpr const char *workspaceAddMenuLogitAdjustmentsItem = "Logit Adjustments";
...
inline constexpr int workspaceAddMenuReductionModelInputItemId = 14;
inline constexpr int workspaceAddMenuVocsepOutputItemId = 15;
inline constexpr int workspaceAddMenuInstrumentLogitsItemId = 16;
inline constexpr int workspaceAddMenuDurationLogitsItemId = 17;
inline constexpr int workspaceAddMenuReductionTemperatureItemId = 18;
inline constexpr int workspaceAddMenuReductionTauItemId = 19;
inline constexpr int workspaceAddMenuOctaveDeltaItemId = 20;
inline constexpr int workspaceAddMenuLogitAdjustmentsItemId = 21;
...
inline constexpr int workspaceInputViewGenerationHeight = 190;
inline constexpr int workspaceInputViewPianoRollWidth = 640;
inline constexpr int workspaceInputViewPianoRollHeight = 280;
inline constexpr int workspaceOrchestrationDebugMidiX = 20;
inline constexpr int workspaceOrchestrationDebugMidiY = 40;
inline constexpr int workspaceOrchestrationDebugReductionX = 20;
inline constexpr int workspaceOrchestrationDebugReductionY = 260;
/** Piano rolls stay in the left half of the 1020 design canvas. */
inline constexpr int workspaceOrchestrationDebugRollWidth = 480;
inline constexpr int workspaceOrchestrationDebugRollHeight = 200;
inline constexpr int workspaceOrchestrationDebugActiveInstrumentsX = 520;
inline constexpr int workspaceOrchestrationDebugActiveInstrumentsY = 930;
inline constexpr int workspaceOrchestrationDebugActiveInstrumentsWidth = 480;
inline constexpr int workspaceOrchestrationDebugActiveInstrumentsHeight = 490;
inline constexpr int workspaceOrchestrationDebugGenerationX = 520;
inline constexpr int workspaceOrchestrationDebugGenerationY = 40;
inline constexpr int workspaceOrchestrationDebugGenerationWidth = 230;
inline constexpr int workspaceOrchestrationDebugGenerationHeight = 180;
inline constexpr int workspaceOrchestrationDebugReductionTemperatureX = 760;
inline constexpr int workspaceOrchestrationDebugReductionTemperatureY = 40;
inline constexpr int workspaceOrchestrationDebugReductionTemperatureWidth = 240;
inline constexpr int workspaceOrchestrationDebugReductionTemperatureHeight = 280;
inline constexpr int workspaceOrchestrationDebugModeX = 520;
inline constexpr int workspaceOrchestrationDebugModeY = 220;
inline constexpr int workspaceOrchestrationDebugModeWidth = 480;
inline constexpr int workspaceOrchestrationDebugModeHeight = 490;
inline constexpr int workspaceOrchestrationDebugDurationLogitsX = 520;
inline constexpr int workspaceOrchestrationDebugDurationLogitsY = 720;
inline constexpr int workspaceOrchestrationDebugDurationLogitsWidth = 200;
inline constexpr int workspaceOrchestrationDebugDurationLogitsHeight = 200;
inline constexpr int workspaceOrchestrationDebugOctaveDeltaX = 730;
inline constexpr int workspaceOrchestrationDebugOctaveDeltaY = 720;
inline constexpr int workspaceOrchestrationDebugOctaveDeltaWidth = 160;
inline constexpr int workspaceOrchestrationDebugOctaveDeltaHeight = 200;
inline constexpr int workspaceOrchestrationDebugReductionTauX = 900;
inline constexpr int workspaceOrchestrationDebugReductionTauY = 720;
inline constexpr int workspaceOrchestrationDebugReductionTauWidth = 180;
inline constexpr int workspaceOrchestrationDebugReductionTauHeight = 200;
inline constexpr int workspaceOrchestrationDebugOutputVisualizerX = 20;
inline constexpr int workspaceOrchestrationDebugOutputVisualizerY = 510;
inline constexpr int workspaceOrchestrationDebugOutputVisualizerWidth = 480;
inline constexpr int workspaceOrchestrationDebugOutputVisualizerHeight = 240;
inline constexpr int workspaceOrchestrationDebugPlaybackOutputX = 20;
inline constexpr int workspaceOrchestrationDebugPlaybackOutputY = 770;
inline constexpr int workspaceOrchestrationDebugPlaybackOutputWidth = 480;
inline constexpr int workspaceOrchestrationDebugPlaybackOutputHeight = 240;
inline constexpr int workspaceOrchestrationDebugReductionTransformerOutputX = 20;
inline constexpr int workspaceOrchestrationDebugReductionTransformerOutputY = 1030;
inline constexpr int workspaceOrchestrationDebugReductionTransformerOutputWidth = 480;
inline constexpr int workspaceOrchestrationDebugReductionTransformerOutputHeight = 180;
inline constexpr int workspaceOrchestrationDebugVocsepOutputX = 20;
inline constexpr int workspaceOrchestrationDebugVocsepOutputY = 1230;
inline constexpr int workspaceOrchestrationDebugVocsepOutputWidth = 480;
inline constexpr int workspaceOrchestrationDebugVocsepOutputHeight = 180;
inline constexpr int workspaceOrchestrationDebugReductionModelInputX = 520;
inline constexpr int workspaceOrchestrationDebugReductionModelInputY = 1030;
inline constexpr int workspaceOrchestrationDebugReductionModelInputWidth = 480;
inline constexpr int workspaceOrchestrationDebugReductionModelInputHeight = 180;
...
inline constexpr int workspaceGenerationClockHeight = 28;
inline constexpr int workspaceGenerationClockTimerIntervalMs = 100; // 0.1s
inline constexpr float workspaceGenerationClockFontHeight = 18.0f;
...
inline constexpr const char *workspaceNewViewDialogTitle = "New View";
inline constexpr const char *workspaceNewViewDialogMessage =
    "Enter a name for the new empty view:";
inline constexpr const char *workspaceNewViewConfirmButton = "Create";
inline constexpr const char *workspaceNewViewCancelButton = "Cancel";
inline constexpr int workspaceToolbarNewViewButtonWidth = 88;
...
/** NoteIoWidget snapshot / table refresh (OT debug, playback, etc.). */
inline constexpr int noteIoWidgetTimerIntervalMs = 10;
...
/** When multiple instruments share a note cell, cycle colours along time every N centiseconds. */
inline constexpr int32_t pianoRollMultiColourStripeCs = 30; // 0.3s
