# Convert GPT-2 models to ggml format
#
...
if len(sys.argv) < 2:
    print("Usage: torch_to_ggml.py dir-model [use-f32]\n")
    sys.exit(1)

# output in the same directory as the model
dir_model = sys.argv[1]
fname_out = sys.argv[1] + "/ggml-model-f16.ggml"
...
if len(sys.argv) > 2:
    use_f16 = False
    fname_out = sys.argv[1] + "/ggml-model-f32.ggml"
