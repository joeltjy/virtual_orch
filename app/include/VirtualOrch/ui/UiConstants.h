...
inline constexpr int workspaceOrchestrationDebugConditioningX = 20;
...
inline constexpr int workspaceOrchestrationDebugReductionTemperatureHeight = 180;
...
inline constexpr int workspaceOrchestrationDebugInstrumentLogitsX = 520;
inline constexpr int workspaceOrchestrationDebugInstrumentLogitsY = 720;
inline constexpr int workspaceOrchestrationDebugInstrumentLogitsWidth = 300;
inline constexpr int workspaceOrchestrationDebugInstrumentLogitsHeight = 200;
inline constexpr int workspaceOrchestrationDebugReductionTauX = 830;
inline constexpr int workspaceOrchestrationDebugReductionTauY = 720;
inline constexpr int workspaceOrchestrationDebugReductionTauWidth = 170;
...
inline constexpr int workspaceOrchestrationDebugOutputVisualizerY = 730;
...
inline constexpr int workspaceOrchestrationDebugPlaybackOutputY = 990;
...
inline constexpr int workspaceOrchestrationDebugReductionTransformerOutputY = 1250;
...
inline constexpr int workspaceOrchestrationDebugVocsepOutputY = 1450;
...
inline constexpr int workspaceOrchestrationDebugReductionModelInputY = 1250;
